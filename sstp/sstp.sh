...
curl -sS "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/accel.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/accel-ppp.conf
...
#input perintah sstp
wget -q -O /usr/bin/add-sstp "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/add-sstp.sh" && chmod +x /usr/bin/add-sstp
wget -q -O /usr/bin/del-sstp "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/del-sstp.sh" && chmod +x /usr/bin/del-sstp
wget -q -O /usr/bin/cek-sstp "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/cek-sstp.sh" && chmod +x /usr/bin/cek-sstp
wget -q -O /usr/bin/renew-sstp "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/renew-sstp.sh" && chmod +x /usr/bin/renew-sstp
wget -q -O /usr/bin/trial-sstp "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/trial-sstp.sh" && chmod +x /usr/bin/trial-sstp
wget -q -O /usr/bin/port-sstp "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/sstp/port-sstp.sh" && chmod +x /usr/bin/port-sstp
wget -q -O /usr/bin/sstp-menu "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/menu_all/sstp-menu.sh" && chmod +x /usr/bin/sstp-menu
