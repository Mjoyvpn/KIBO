...
wget -q -O /usr/bin/add-ss "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/shadowsocks/add-ss.sh" && chmod +x /usr/bin/add-ss
wget -q -O /usr/bin/del-ss "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/shadowsocks/del-ss.sh" && chmod +x /usr/bin/del-ss
wget -q -O /usr/bin/cek-ss "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/shadowsocks/cek-ss.sh" && chmod +x /usr/bin/cek-ss
wget -q -O /usr/bin/renew-ss "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/shadowsocks/renew-ss.sh" && chmod +x /usr/bin/renew-ss
wget -q -O /usr/bin/trial-ss "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/shadowsocks/trial-ss.sh" && chmod +x /usr/bin/trial-ss
wget -q -O /usr/bin/ss-menu "https://raw.githubusercontent.com/Mjoyvpn/KIBO/main/menu_all/ss-menu.sh" && chmod +x /usr/bin/ss-menu
